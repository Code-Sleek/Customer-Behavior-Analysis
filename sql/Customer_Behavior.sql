...
--Q1. What is the toltal revenue generated by male vs. female customers ?
...
select subscription_status, round(avg(purchase_amount),2) as "avg_spend", round(sum(purchase_amount),2) as "total_revenue", count(customer_id) as "total_customers"
from customer
